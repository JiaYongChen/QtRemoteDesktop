...
void TestScreenDataFlow::test_screenDataEncoding()
{
    ...
    screenData.compressionType = 1; // 压缩
...
void TestScreenDataFlow::test_screenDataDecoding()
{
    ...
    originalData.compressionType = 0; // 无压缩
    ...
    QCOMPARE(decodedData.compressionType, originalData.compressionType);
...
void TestScreenDataFlow::test_dataIntegrity()
{
    ...
    for (int i = 0; i < testDataList.size(); ++i) {
        ...
        QCOMPARE(decoded.compressionType, original.compressionType);
